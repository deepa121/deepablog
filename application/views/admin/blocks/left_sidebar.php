...
<div class="navbar-brand-box">
    <a href="<?php base_url('admin/Admin/index1');?>" class="logo logo-dark">
        ...
        <span class="logo-lg">
            <img src="<?php echo base_url(); ?>assets/admin/images/logo-dark.png" alt="" height="20">
        </span>
    </a>
    ...
    <a href="<?php base_url();?>" class="logo logo-light">
        ...
        <span class="logo-lg">
            <img src="<?php echo base_url(); ?>assets/admin/images/logo-light.png" alt="" height="20">
        </span>
    </a>
</div>
...
<div data-simplebar="" class="sidebar-menu-scroll">
    ...
    <div id="sidebar-menu">
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                <a href="<?php echo base_url('admin/category/Category') ?>" class="waves-effect">
                    <i class="uil-store"></i>
                    <span>Category</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('admin/category/Subcategory') ?>" class="waves-effect">
                    <i class="uil-store"></i>

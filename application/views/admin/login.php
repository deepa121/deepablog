...
<div class="login-box">
  ...
  <div class="card">
    ...
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url('admin/Admin/login_compare'); ?>" method="post">
      ...
      <div class="social-auth-links text-center mb-3">
        <p>- OR -</p>
        <p class="mb-1">
        <a href="<?php echo base_url('admin/Admin/forgot_pass') ?>" class="btn btn-warning "><i class="fas fa-key mr-2"></i>FORGOT PASSWORD</a>
